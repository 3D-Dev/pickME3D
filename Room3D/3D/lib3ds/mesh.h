...
#define CALC_NORMAL_AT_LOADING_TIME 1 /*002-->calc vertex normal at loading time*/
...
struct Lib3dsMesh {
	...
	Lib3dsVector *normalL;		/*< Normal list */
#endif
...
#if CALC_NORMAL_AT_LOADING_TIME /*002-->calc vertex normal at loading time*/
extern LIB3DSAPI Lib3dsBool lib3ds_mesh_new_normal_list(Lib3dsMesh *mesh);
