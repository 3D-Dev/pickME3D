...
mat4 & look_at(mat4& M, const vec3& eye, const vec3& center, const vec3& up)
{
	...
	M.a30 = fzero; M.a31 = fzero; M.a32 = fzero; M.a33 = fone;
	return M;
}
...
mat4 & perspective(mat4& M, const float fovy, const float aspect, const float n, const float f)
{
	...
	ymax = n * tanf(fovy * fto_rad * fzero_5);
	ymin = -ymax;
...
extern mat4 & ortho(mat4 & M, const float left, 
					...
					const float f)
{
	M.a00 = ftwo / (right - left);
	M.a01 = fzero;
	M.a02 = fzero;
	M.a03 = - (right + left) / (right - left);
	M.a10 = fzero;
	M.a11 = ftwo / (top - bottom);
	M.a12 = fzero;
...
mat3& tangent_basis(mat3& basis, const vec3& v0, const vec3& v1, const vec3& v2, const vec2& t0, const vec2& t1, const vec2& t2, const vec3 & n)
{
	...
	// tangent...
	float oonorm = fone / sqrtf(basis.a00 * basis.a00 + basis.a01 * basis.a01 + basis.a02 * basis.a02);
	basis.a00 *= oonorm;
	basis.a01 *= oonorm;
	basis.a02 *= oonorm;

	// binormal...
	oonorm = fone / sqrtf(basis.a10 * basis.a10 + basis.a11 * basis.a11 + basis.a12 * basis.a12);
	basis.a10 *= oonorm;
	basis.a11 *= oonorm;
	basis.a12 *= oonorm;
	...
	oonorm = fone / sqrtf(basis.a20 * basis.a20 + basis.a21 * basis.a21 + basis.a22 * basis.a22);
	basis.a20 *= oonorm;
	basis.a21 *= oonorm;
	basis.a22 *= oonorm;
	...
	if (basis.a20 * n.x + basis.a21 * n.y + basis.a22 * n.z < fzero)
	{
		basis.a20 = -basis.a20;
		basis.a21 = -basis.a21;
		basis.a22 = -basis.a22;
...
{
	float s, t, sc, tc;
	s = (float(x) + fzero_5) / float(cubesize);
	t = (float(y) + fzero_5) / float(cubesize);
	sc = s * ftwo - fone;
	tc = t * ftwo - fone;
